...
function MilestoneCard({ milestone, isLeft }: { milestone: Milestone; isLeft: boolean }) {
  ...
  return (
    ...
    >
      {/* Glowing Orb */}
      <div className="w-8 h-8 bg-gradient-to-b from-[#d49a43] via-[#f3c77b] to-[#d49a43] rounded-full border-4 border-[#f3c77b] shadow-[0_0_32px_#d49a43] animate-pulse absolute left-1/2 transform -translate-x-1/2 -top-4"></div>
      <div
  ...
  return (
    <section className="relative py-20 bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      <div className="relative flex flex-col items-center w-full max-w-4xl mx-auto">
        ...
        <div className="absolute left-1/2 top-0 -translate-x-1/2 h-full w-2 bg-gradient-to-b from-[#d49a43] via-[#f3c77b] to-transparent shadow-[0_0_32px_#d49a43] animate-pulse pointer-events-none z-0" />
